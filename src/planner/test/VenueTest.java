...
public class VenueTest {
    ...
    public void testNullTrafficParameter() {
        // venue parameters
        String name = "Suncorp Stadium";
        int capacity = 100;
        Traffic capacityTraffic = null;
    ...
    /**
     * Test that the appropriate exception is thrown if a venue is created with
     * a capacity that is less than or equal to zero.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testIllegalParameterConstructor() {
        // venue parameters
        String name = "Suncorp Stadium";
        int invalidCapacity1 = 0;
        int invalidCapacity2 = -50;
        Traffic capacityTraffic = trafficRecords[0];

        // the venues under test
        Venue venue2 = new Venue(name, invalidCapacity1, capacityTraffic);
        Venue venue3 = new Venue(name, invalidCapacity2, capacityTraffic);
    }
    ...
    /**
     * Test to see if the canHost method throws the appropriate Exception
     */
    @Test(expected = NullPointerException.class)
    public void testCanHostNullPointer(){
        // venue parameters
        String name = "Suncorp Stadium";
        int capacity = 100;
        Traffic capacityTraffic = trafficRecords[1];
    ...
    public void testEquals() {
        ...
        venues[0] = new Venue("Suncorp Stadium", 100,
                trafficRecords[1]);
        venues[1] = new Venue("Suncorp Stadium", 100, new Traffic(
                trafficRecords[1]));
        venues[2] = new Venue("The Gabba", 200, trafficRecords[0]);
        ...
        // Test with a class that is not a venue
        Assert.assertFalse(venues[2].equals(new Object()));
    }

    /**
     * Test that the appropriate exception is thrown if an Event is null
     */
    @Test(expected = NullPointerException.class)
    public void testGetTrafficForNullEvent(){
        // venue parameters
        String name = "Suncorp Stadium";
        int capacity = 100;
        Traffic capacityTraffic = trafficRecords[1];
        //Event testEvent = new Event("Contrapoints Talk", 2000);

        // the venue under test
        Venue venue = new Venue(name, capacity, capacityTraffic);

        // test the exception thrown
        venue.getTraffic(null);
    }

    /**
     * Test that the appropriate exception is thrown if an Event is larger than
     * the Venue's capacity
     */
    @Test(expected = IllegalArgumentException.class)
    public void testGetTrafficForEventLargerThanCapacity(){
        // venue parameters
        String name = "Suncorp Stadium";
        int capacity = 100;
        Traffic capacityTraffic = trafficRecords[1];
